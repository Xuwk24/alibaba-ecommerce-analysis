...
def module2_funnel(df):
    ...
    # --- 2.2 绘制漏斗图 ---
    # 使用 matplotlib 绘制梯形漏斗
    fig, ax = plt.subplots(figsize=(10, 6))

    step_names = [s[0] for s in funnel_steps]
    ...
    for i, (name, val) in enumerate(funnel_steps):
        ...
        if i > 0:
            ...
            ax.text(0.92, y_bottom + 0.5, f"步骤转化率: {step_cr:.1f}%\n流失率: {100-step_cr:.1f}%",
